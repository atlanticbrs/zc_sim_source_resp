...
```{r, fig-9-timeseries-three-whales, fig.width = 20, fig.height=7}
plot_grid(tag_data17, tag_data19, tag_data20,
          labels = c('(a)', '(b)', '(c)'),
          label_size = 26, vjust = 1, hjust = -0.5,
          ncol = 3,
          rel_widths = c(1,1),
          align = 'hv')
```
...
temp$data[[1]]$fill = 'grey70'
temp$plot$theme <- theme_bw(base_size = 16) + 
  theme(text = element_text(family="Times New Roman"),
        strip.text.y = element_blank())
#temp$plot$theme$text$size = 16
#temp$plot$theme$text$family = 'Times New Roman'
...
```{r, fig-10-all-diff-smooths, fig.height = 10, fig.width=8}
